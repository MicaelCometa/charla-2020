...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab3-tab3-module"], {
  ...
  function srcAppTab3Tab3PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_api_superhero_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../services/api/superhero.service */
    "./src/app/services/api/superhero.service.ts");

    var Tab3Page = function Tab3Page(superHeroService) {
      var _this = this;
      ...
      this.superHeroService.getHeroName().then(function (data) {
        ...
        _this.superHeroName = data;
        _this.avatar = data.split(' ')[0].toLowerCase();

        var imgName = _this.avatar.normalize('NFD').replace(/[\u0300-\u036f]/g, "");

        _this.avatar = imgName + '.png'; //this.avatar = "zanahoria.png";
      });
    };
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_api_superhero_service__WEBPACK_IMPORTED_MODULE_2__["SuperheroService"]])], Tab3Page);
    /***/
  }
}]);
